# A default configuration that applies to all servers (SrvOS)
...
{ config, lib, ... }:
{
  ...
  imports = [
    ...
    ./mdmonitor-fix.nix
    ./networking.nix
    # ./nix.nix # shared between NixOS and nix-darwin, in hosts/common folder
    ./openssh.nix
    ./serial.nix
    ./sudo.nix
    # ./upgrade-diff.nix # shared between NixOS and nix-darwin
    # ./well-known-hosts.nix # shared between NixOS and nix-darwin
    ./zfs.nix
  ];
